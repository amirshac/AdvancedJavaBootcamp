 ...
 */
	...
	public static void changeArrayToSumOfArrays(int[] arr1, int[] arr2)
	{
		...
		longerArr = createSumArray(arr1, arr2);
	}
...
//------------------------------------------------------------------------
	...
	public static void execute64a() {
		int result = sumOfDigits(123);	
		System.out.println(result);
	}
	
	// EX 6.4b
	public static void execute64b() {
		int[] arr = {91, 820, 721, 23};
		int result = numberOfElementsWithSumOfDigits(arr, 10);
		System.out.println(result);		
	}
	
	// EX 6.6 - perfect matrix
	public static void execute66() {
		int [][]matrix = {
				{2,1,5},
				{6,7,3},
				{0,8,0} 
